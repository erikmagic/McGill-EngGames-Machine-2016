...
#define MOTOR_DIR_L 5 // digital left direction
#define MOTOR_SPD_L 4 // analog left speed
#define MOTOR_DIR_R 3 // digital right direction
#define MOTOR_SPD_R 2 // analog right speed
...
void loop() {
    ...
    if ( radio.available())
    {
      ...
      Serial.print(F("Hat Position = "));
      Serial.println(myData.hatPosition);
      Serial.print(F("Right joystick in x = "));
      Serial.println(myData.rightX);
      Serial.print(F("Right joystick in y = "));
      Serial.println(myData.rightY);
      Serial.print(F("Left joystick in x = "));
      Serial.println(myData.leftX);
      Serial.print(F("Left joystick in y = "));
